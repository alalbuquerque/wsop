...
<header>
	<div class="logo mobile-hidden">
		<a href="http://wsopbr.com"><img src="dist/images/logo.png" class="logo" alt="WSOP Circut" role="logo" width="100%"></a>
	</div>
	...
	<nav role="menu" class="desktop-hidden">
		<ul class="menu">
			...
			<li><a href="satellites.php">Satélites</a></li>
			<li><a href="gallery.php">Galeria</a></li>
			<li><img src="dist/images/logo.png" class="logo animated slideInDown" alt="WSOP Circut" role="logo"></li>
			<li><a href="news.php">News</a></li>
			<li><a href="results.php">Resultados</a></li>
			<li><a href="contact.php">Contato</a></li>
			<li>
